...
When reading or understanding code, prefer the project CodeGraph tools before native file search or broad file reads. Use CodeGraph for structural questions such as definitions, callers, callees, data flow, change impact, and task-focused symbol context.
