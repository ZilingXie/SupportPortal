...
## Source Of Truth
1. `AGENTS.md` is the repository source of truth; `CLAUDE.md` mirrors those hot-path rules for Claude Code.
2. `REASONIX.md` is the Reasonix exception and keeps Reasonix in handoff-before-review mode.
