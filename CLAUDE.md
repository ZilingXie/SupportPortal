...
## Source Of Truth
1. `AGENTS.md` is the repository source of truth; `CLAUDE.md` is the Claude Code mirror of those hot-path rules.
...
3. `REASONIX.md` is the worker-specific exception and keeps Reasonix in handoff-before-review mode.
