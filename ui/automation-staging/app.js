...
const ENV = {
  environment: "staging",
  template: "account",
  apiBase: "/automation/staging",
  tokenKey: "automation-staging-execution-token",
  brandEyebrow: "AUTOMATION / STAGING",
  brandTitle: "Automation staging",
  loginTagline: "Run route executions against the staging ledger. Zendesk delivery is disabled.",
  workbenchPill: "Local ledger · no Zendesk",
  submitLabel: "Run Route",
  requiresTicket: false,
  ticketHint: "",
  visibilityMode: "none",
  fixedVisibility: null,
  casePlaceholder: "AC-STAGING-001",
/*__RERUN_START__*/
  rerunWritesZendesk: false,
/*__RERUN_END__*/
};
