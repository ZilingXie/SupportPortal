...
const ENV = {
  ...
  template: "production",
  apiBase: "/automation/production",
  tokenKey: "automation-production-execution-token",
  brandEyebrow: "AUTOMATION / PRODUCTION",
  brandTitle: "Automation production",
  loginTagline: "Run production ticket executions with explicit internal or external Zendesk delivery.",
  workbenchPill: "Zendesk delivery · explicit visibility",
  submitLabel: "Run Production",
  requiresTicket: true,
  ticketHint: "Live Zendesk ticket",
  visibilityMode: "select",
  fixedVisibility: null,
  casePlaceholder: "AC-PRODUCTION-001",
};
