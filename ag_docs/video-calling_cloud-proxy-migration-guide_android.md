...
platform: android
exported_from: https://docs.agora.io/en/video-calling/reference/cloud-proxy-migration-guide?platform=android
exported_on: '2026-01-20T05:58:40.826891Z'
exported_file: cloud-proxy-migration-guide_android.md
---

[HTML Version](https://docs.agora.io/en/video-calling/reference/cloud-proxy-migration-guide?platform=android)
...
> * Test your configuration thoroughly using the [validation steps](https://docs-md.agora.io/en/video-calling/reference/cloud-proxy-allowed-ips.md).
