...
platform: android
exported_from: https://docs.agora.io/en/video-calling/reference/status-page
exported_on: '2026-01-20T05:58:55.717582Z'
exported_file: status-page.md
---

[HTML Version](https://docs.agora.io/en/video-calling/reference/status-page)
...
Use the Status Page page to track service performance, maintenance events, and disruptions. The Status Page offers RSS push notifications for updates on ongoing events and combines multiple indicators to deliver comprehensive QoE data.
...
![](https://docs-md.agora.io/images/status-page/status-page.png)
...
1. Click the **Events** button in the health banner.
    ...
    ![](https://docs-md.agora.io/images/status-page/status-historical-events.png)

1. Select a specific event from the list to view its details. 

    ![](https://docs-md.agora.io/images/status-page/status-event-details.png)
...
![](https://docs-md.agora.io/images/status-page/status-product-filter.png)
...
![](https://docs-md.agora.io/images/status-page/status-check-running.png)
...
1. **Global comprehensive service quality**
    ...
    ![](https://docs-md.agora.io/images/status-page/status-hover.png)
...
1. **24-hour real-time experience metrics**
    ...
    ![](https://docs-md.agora.io/images/status-page/status-quality-metrics.png)
...
3. **90-day service status**
    ...
    ![](https://docs-md.agora.io/images/status-page/status-event-popup.png)
