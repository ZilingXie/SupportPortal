---
title: Overview
description: Intro to the Agora channel management APIs
sidebar_position: 1
platform: android
exported_from: https://docs.agora.io/en/video-calling/channel-management-api/overview
exported_on: '2026-01-20T05:57:33.307969Z'
exported_file: overview.md
---

[HTML Version](https://docs.agora.io/en/video-calling/channel-management-api/overview)
...
Use the channel management RESTful API along with the [Notifications](https://docs-md.agora.io/en/video-calling/advanced-features/receive-notifications.md) service for reliable and effective channel management and status synchronization.
