...
description: How to make calls to Agora RESTful API
sidebar_position: 2
platform: android
exported_from: https://docs.agora.io/en/video-calling/channel-management-api/how-to-call-api
exported_on: '2026-01-20T05:57:32.934787Z'
exported_file: how-to-call-api.md
---

[HTML Version](https://docs.agora.io/en/video-calling/channel-management-api/how-to-call-api)
...
- `Authorization`: The Agora RESTful API requires HTTP authentication. Every time you send an HTTP request, fill in the `Authorization` field in the request header. See [RESTful authentication](https://docs-md.agora.io/en/video-calling/channel-management-api/restful-authentication.md) for details.
...
If you encounter a problem, use developer tools to view the request and response, and troubleshoot based on the response status code. If the problem persists, contact [technical support](https://docs-md.agora.io/en/mailto:support@agora.io.md).