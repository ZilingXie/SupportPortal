...
description: Use the facial capture extension to capture facial data such as facial
  feature points, head rotation, and head translation.
sidebar_position: 16
platform: android
exported_from: https://docs.agora.io/en/video-calling/advanced-features/face-capture?platform=android
exported_on: '2026-01-20T05:56:32.209357Z'
exported_file: face-capture_android.md
---

[HTML Version](https://docs.agora.io/en/video-calling/advanced-features/face-capture?platform=android)
...
> ℹ️ **Information**
> To avoid collecting facial data through callbacks and building your own collection, encoding, and transmission framework, use the Agora [MetaKit extension](https://docs-md.agora.io/en/video-calling/advanced-features/metakit.md) for facial capture.
...
- Obtained obtained the face capture authentication parameters `authentication_information` and `company_id` by contacting [Agora technical support](https://docs-md.agora.io/en/mailto:extensions.marketplace@agora.io.md).
