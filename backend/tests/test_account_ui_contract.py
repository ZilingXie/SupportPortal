...
class AccountUiContractTests(unittest.TestCase):
    ...
    def test_account_html_uses_client_shared_assets(self) -> None:
        ...
        self.assertIn("20260730-account-filter-groups", html)
    ...
    def test_account_app_contains_filter_state_and_reply_composer(self) -> None:
        ...
        self.assertIn('statusFilter: "agora_technical"', app_source)
        ...
        self.assertIn('{ value: "agora_technical", label: "Agora Technical" }', filter_options)
        self.assertIn('{ value: "account_billing", label: "Account & Billing" }', filter_options)
        self.assertIn('{ value: "human_review", label: "Human Review" }', filter_options)
        self.assertIn('{ value: "automation", label: "Automation" }', filter_options)
        self.assertIn('{ value: "conversation", label: "Conversation" }', filter_options)
        self.assertNotIn('{ value: "unreviewed"', filter_options)
        self.assertNotIn('{ value: "reviewed"', filter_options)
        self.assertNotIn('{ value: "all"', filter_options)
        self.assertNotIn('{ value: "not_automated"', filter_options)
        self.assertNotIn('{ value: "route_errors"', filter_options)
        self.assertNotIn('{ value: "agora_non_technical"', filter_options)
