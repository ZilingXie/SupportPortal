...
class AssignmentUiContractTests(unittest.TestCase):
    ...
    def test_assignment_ui_contains_welcome_ready_and_admin_flow(self) -> None:
        ...
        self.assertIn("Queue &amp; engineer overview", app_source)
        self.assertIn("Engineer overview", app_source)
        self.assertIn("Weekly schedule", app_source)
        self.assertIn("On shift now", app_source)
        self.assertIn("Online coverage", app_source)
        self.assertIn("Online", app_source)
        self.assertIn("Offline", app_source)
        self.assertIn("admin-engineer-overview", app_source)
        self.assertIn("admin-schedule-grid", app_source)
        self.assertIn("schedule-chip", app_source)
        self.assertIn("admin-shift-picker", app_source)
        self.assertIn("Edit selected shift", app_source)
        ...
        self.assertIn(".admin-shift-picker", css)
