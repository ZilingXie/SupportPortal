...
class AssignmentUiContractTests(unittest.TestCase):
    ...
    def test_assignment_ui_contains_welcome_ready_and_admin_flow(self) -> None:
        ...
        # Admin page — Ticket Pool content view
        self.assertIn("adminSection", app_source)
        self.assertIn("renderAdminShell", app_source)
        self.assertIn("renderAdminEngineerManagement", app_source)
        self.assertIn("renderAdminTicketPool", app_source)
        self.assertIn("admin-show-ticket-pool", app_source)
        self.assertIn("admin-show-engineer-management", app_source)
        self.assertIn("admin-ticket-pool-layout", app_source)
        self.assertIn("admin-pool-sidebar", app_source)
        self.assertIn("admin-pool-panel", app_source)
        self.assertIn("Active Pool", app_source)
        self.assertIn("View Filters", app_source)
        self.assertIn("Queue Metrics", app_source)
        self.assertIn("All Open Tickets", app_source)
        self.assertIn("Engineer Handling", app_source)
        self.assertIn("Pending Triage", app_source)
        self.assertIn("Sorted by Urgency", app_source)
        self.assertIn("AI Insight", app_source)
        self.assertIn("Handoff Context", app_source)
        self.assertNotIn("Nexus Insight", app_source)
        ...
        self.assertIn(".admin-ticket-pool-layout", css)
        self.assertIn(".admin-pool-sidebar", css)
        self.assertIn(".admin-pool-filter-card", css)
        self.assertIn(".admin-pool-metrics-card", css)
        self.assertIn(".admin-pool-panel", css)
        self.assertIn(".admin-pool-stat-grid", css)
        self.assertIn(".admin-ticket-card", css)
        self.assertIn(".admin-ticket-insight", css)
        self.assertIn(".admin-ticket-fab", css)
