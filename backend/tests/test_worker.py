...
class WorkerResilienceTests(unittest.TestCase):
    ...
    def test_unpublished_enablement_completion_v16_needs_v17_persona_render(self) -> None:
        ...
        rendered = types.SimpleNamespace(
            ...
            model="persona-model",
            prompt_version="automation-persona-v19",
        )
        ...
        self.assertEqual(worker.AUTOMATION_PERSONA_PROMPT_VERSION, "automation-persona-v19")
        self.assertEqual(
            render.call_args.kwargs["reply_facts"]["completion_acknowledgement"],
            "additional_information",
        )
        self.assertEqual(job["payload"]["persona_prompt_version"], "automation-persona-v19")
        repository.publish_account_reply.assert_called_once()
