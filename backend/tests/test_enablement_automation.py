...
class EnablementAutomationTests(unittest.TestCase):
    ...
    def test_rerun_payload_uses_persisted_to_and_cc_arrays(self) -> None:
        payload = {
            "to": "persisted@example.com",
            "to_addresses": ["persisted@example.com", "second@example.com"],
            "cc_addresses": ["owner@example.com"],
            "recipient_resolution_source": "persisted_payload",
            "subject": "Request",
            "body": "Body",
        }
        with patch.dict(
