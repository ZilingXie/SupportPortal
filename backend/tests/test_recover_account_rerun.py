...
class RecoverAccountRerunTests(unittest.TestCase):
    ...
    def test_apply_recovery_persona_unavailable_marks_reset_case_human_review(self) -> None:
        ...
        self.assertEqual(account_case["scope_label"], "human_review")
        self.assertEqual(account_case["route_family"], "human_review")
        self.assertEqual(account_case["execution_action"], "human_review_required")
    ...
    def test_apply_recovery_continues_after_unavailable_and_reuses_existing_persona(self) -> None:
        ...
        self.assertEqual(unavailable_case["route"], "human_review_required")
