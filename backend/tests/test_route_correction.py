...
class RouteCorrectionValidationTests(unittest.TestCase):
    ...
    def test_valid_tuple_dictionary_matches_contract(self) -> None:
        expected_pairs = {
            ...
            ("uncertain", "human_review_required", "human_review", "classification_only"),
            ("uncategorized", "human_review_required", "human_review", "classification_only"),
            ...
            ("automation", "enablement", "automated", "deterministic_enablement_intake"),
            ("automation", "quota", "automated", "deterministic_quota_intake"),
