...
def build_refusal_answer(decision: SupportRouteDecision) -> str:
    if decision.response_language == "zh":
        return (
            ...
            "这个问题不在我的支持范围内。如果你有 Agora 产品、SDK、API 或集成相关问题，我可以继续帮你。"
        )
    return (
        "I'm Agora's support AI and mainly answer Agora-related questions. "
        "This request is outside my support scope. If you have an Agora product, SDK, API, or integration question, I can help with that."
    )
