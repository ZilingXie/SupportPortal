        ...
        },
        {
            ...
            "prompts": [
                ...
                _prompt(
                    ...
                    "hermes-support-session",
                    build_hermes_route_manual(),
                    version=HERMES_ROUTE_MANUAL_VERSION,
                ),
                _prompt(
                ...
                _prompt(
                    ...
                    "Hermes enablement automation manual",
                    "hermes-agent-tools",
                    build_hermes_automation_enablement_manual(),
                    version=HERMES_AUTOMATION_ENABLEMENT_MANUAL_VERSION,
                ),
                _prompt(
                    "hermes-automation-verification-manual",
                    "Hermes verification automation manual",
                    "hermes-agent-tools",
                    build_hermes_automation_verification_manual(),
                    version=HERMES_AUTOMATION_VERIFICATION_MANUAL_VERSION,
                ),
                _prompt(
                    "hermes-automation-fraud-manual",
                    "Hermes fraud/billing automation manual",
                    "hermes-agent-tools",
                    build_hermes_automation_fraud_manual(),
                    version=HERMES_AUTOMATION_FRAUD_MANUAL_VERSION,
                ),
                _prompt(
                    "hermes-automation-suspension-manual",
                    "Hermes suspension automation manual",
                    "hermes-agent-tools",
                    build_hermes_automation_suspension_manual(),
                    version=HERMES_AUTOMATION_SUSPENSION_MANUAL_VERSION,
                ),
            ],
            "skills": [],
            "mcp_servers": [],
