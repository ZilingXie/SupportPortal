...
def build_engineer_investigation_reply_system_prompt() -> str:
    return "\n".join(
        [
            ...
            "",
            "## Decision Rules",
            'If the engineer update is sufficient for the next customer-facing step, set state to "awaiting_confirmation".',
            'If more internal clarification is still needed, set state to "active".',
            ...
            'Top-level keys: "state", "message", "draft_customer_reply", and "engineer_agent_state".',
