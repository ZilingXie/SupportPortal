...
def build_router_system_prompt(*, route_examples: list[dict[str, Any]]) -> str:
    ...
    return "\n".join(
        [
            ...
            "- eligible: for billing.detailed_invoice with complete transaction/date/amount data and no dispute/refund signals, or for billing.account_verification with no refund/dispute/legal risk flags",
