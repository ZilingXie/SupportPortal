...
| 06 · R&D Agent dialogue | 01:55-02:20 | `phase1.html#agentrelay` | Zoom into the R&D Agent example: question, `Client.unpublish` evidence, and abnormal-disconnection exclusion. | Demonstrate that R&D/Data Agents produce reusable evidence instead of free-form chat. |
| 07 · Guardrail showcase | 02:20-02:45 | `phase1_video/7-show-case.png` | Show the Support Agent and Engineer dialogue: unsafe root-cause claim, rejection reason, Web SDK evidence, and customer-safe draft. | Demonstrate how Guardrail rejects incomplete replies before customers see them. |
...
- `phase1_video/7-show-case.png`: Guardrail showcase dialogue.
