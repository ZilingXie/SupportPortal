...
| Scene 07 | 00:54-01:03 | 9s | `phase1_video/6-2-engineer.png` | Assignment gives the team route, owner, review, SLA risk, and fallback control. | 继续展示 engineer 端，不展示 `/workspace/admin`。 |
