window.SUPPORTPORTAL_PROJECT_DATA = {
  "schema_version": 2,
  "generated_at": "2026-08-26T02:02:59Z",
  "source_base_commit": "d8d49adf590728af8d4cf829fc1caab710a4eb50",
  "registry_digest": "7d5c826253f2fcf67a67037f845ea5940040d10ebe5eb414af30be194e769786",
  "project": {
    "schema_version": 2,
  ...
  "tasks": [
    ...
    },
    {
      ...
      "next_action": "EC2 split runtime下线与 main-only部署门禁已完成；下一步确认 AWS Region、与现有 RDS 同 VPC 的 private/public subnet、Route53 hosted zone、三环境域名和 GitHub Actions OIDC权限，随后实现 ECR/ECS/Terraform发布链并先部署 ECS Staging。",
      "acceptance_criteria": [
