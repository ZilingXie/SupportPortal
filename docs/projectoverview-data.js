window.SUPPORTPORTAL_PROJECT_DATA = {
  "schema_version": 2,
  "generated_at": "2026-08-29T16:13:33Z",
  "source_base_commit": "2c90d125e085fbcf1e9dee9ba4aa7a273b2f8fb5",
  "registry_digest": "1e7fc7b291f2b4a5fe00b43043b4d46e1af8fae5b0489c49e378011df2d2266f",
  "project": {
    "schema_version": 2,
  ...
  "tasks": [
    ...
    },
    {
      ...
      "status": "active",
      "owner": "zac",
      "summary": "按 Stage 0盘点、Stage 1设计、Stage 2本地 release、Stage 3 ECS Foundation、Stage 4 Preproduction验收、Stage 5同 digest晋升 Production、Stage 6 EC2 Staging、Stage 7切流的顺序迁移 Automation。新的 ECS入口为 supportcenter.stellarix.space/automation/production；support.stellarix.space/production保持不变作为 EC2 backup。Account parity release使用独立 API、Route Worker和 Automation Worker，以 RDS durable Jobs交接并调用远端 RAG；Worker同时消费 Account reply/delivery jobs和 Billing、Enablement、Quota Outlook内部回复。r20260829-e6cffca三角色镜像已上传 Production ECR，API revision 2已单副本运行并通过 live/release/受控 readiness门禁，Route/Worker尚未启动。Slack Engineer Case thread binding、@bot、Guardrail与Final Approve明确延期，不得宣称完整/production parity。",
      "next_action": "分别启动 r20260829-e6cffca 的 Route Worker和 Automation Worker，确认两者使用匹配的 release、commit、image、build与 Prompt provenance持续写入新鲜 heartbeat，使 /automation/production/health/ready从受控503转为200；随后使用受控测试 Case完成 Account intake、异步处理、远端RAG、内部邮件回复、Zendesk/comment/status与delivery readback验收。supportcenter.stellarix.space尚无DNS记录，DNS与n8n切换继续保持暂停，EC2 /production不变。",
      "acceptance_criteria": [
