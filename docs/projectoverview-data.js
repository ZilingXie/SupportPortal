window.SUPPORTPORTAL_PROJECT_DATA = {
  "schema_version": 2,
  "generated_at": "2026-09-02T05:49:34Z",
  "source_base_commit": "d0987e00755764fd71243dd7efe7b0a45e0c8375",
  "registry_digest": "97e83abedc4bd97dfff019e002b4971457cfb6abceb6babb6a4037cafaa05df4",
  "project": {
    "schema_version": 2,
  ...
  "tasks": [
    ...
    },
    {
      ...
      "next_action": "13218 验收通过但 enabled 回复不应向客户披露 oversea region / load 50；已改为仅告知 Media Relay 已开启（intake facts 注入、persona 政策、校验器三处协同，Skill 不动）。待合并部署后用下一张全新 enablement 工单（建议选尚无 typeId=6 配置的项目以覆盖创建分支）验证新文案，并补齐非法格式/查无项目两类验收后转 done。",
      "acceptance_criteria": [
