...
def neo4j_safe_value(value: Any) -> Any:
    """Convert any value to a Neo4j-safe type (primitive or array thereof)."""
    import json
...
def neo4j_safe_attributes(attributes: dict[str, Any]) -> dict[str, Any]:
    """Filter and convert attributes dict to Neo4j-safe values."""
    result = {}
